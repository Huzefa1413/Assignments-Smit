...
function details(el) {
    ...
    for (var key in usersList) {
        ...
        if (usersList[key].id === el) {
            pushData(usersList[key]);
        }
    }
}

function pushData(usersList) {
    var modalDiv = document.getElementById("modalBody");
    modalDiv.innerHTML = '';

    var ul = document.createElement("ul");

    var li = document.createElement('li');
    var text = document.createTextNode("ID: " + usersList.id)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Name: " + usersList.name)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Username: " + usersList.username)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Email: " + usersList.email)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Address: " + usersList.address.street + ", " + usersList.address.suite + ", " + usersList.address.city + ", " + usersList.address.zipcode + ", " + usersList.address.geo.lat + ", " + usersList.address.geo.lng)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Phone: " + usersList.phone)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Website: " + usersList.website)
    li.appendChild(text);
    ul.appendChild(li);

    var li = document.createElement('li');
    var text = document.createTextNode("Company: " + usersList.company.name + ", " + usersList.company.catchPhrase + ", " + usersList.company.bs)
    li.appendChild(text);
    ul.appendChild(li);
